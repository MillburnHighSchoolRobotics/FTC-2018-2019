...
//    }
    ...
    public SahilClass(VuforiaLocalizerImplSubclass vuforiaInstance) {
        ...
        heightCamera = (int) Math.round(0.45*heightCameraOriginal);
...
//        this.length = length;
    ...
    public int getThreeMineralPosition() {
        double[] data = getMineralLocation();
        int min = (int) data[0];
        int max = (int) data[1];
        double x = data[2];
        double y = data[3];
    ...
    private double[] getMineralLocation() {
        ...
        Mat rgbCropped = rgbCamera.submat(heightCamera,heightCameraOriginal,min,max);
